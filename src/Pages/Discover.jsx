     ...
     <main>
      ...
      <article className="layout gap-[35px] flex flex-col">
        ...
        <section className="lg:flex items-center justify-between">
          ...
          <button className="btn discoverFilter" onClick={()=> handleDiscoverModals('eventCategoryModal')}>All Events<MdKeyboardArrowDown size={18} /></button>

          <button className="btn discoverFilter" onClick={()=> handleDiscoverModals('priceModal')}>Price<MdKeyboardArrowDown size={18} /></button>

          <button className="btn discoverFilter" onClick={()=> handleDiscoverModals('dateModal')}>Date<MdKeyboardArrowDown size={18} /></button>
          </div>
          {/* div for search  */}
          <div className="flex items-center pt-4 lg:pt-0 ">
            <input type="search " name="search" id="search" className="border border-[##7E7E7E] lg:w-[386px] w-full rounded-[10px] p-1.5 pl-10 relative" placeholder="Search Events" />
      ...
      <dialog ref={eventCategoryModalRef} className="modal modal-bottom sm:modal-middle">
  <div className="modal-box">
    <form method="dialog">
      {/* if there is a button in form, it will close the modal */}
      <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
    </form>
    <h3 className="font-bold text-lg text-[32px] leading-[100%] tracking-[0%]  text-center p-5">Category</h3>
...
{/* Price Modal */}
      <dialog ref={priceModalRef} className="modal modal-bottom sm:modal-middle">
  <div className="modal-box">
    <form method="dialog">
      {/* if there is a button in form, it will close the modal */}
      <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
    </form>
    <h4 className="font-bold text-lg text-[32px] leading-[100%] tracking-[0%]  text-center">Price</h4>
...
{/* Date Modal */}
  ...
  <div className="modal-box">
    ...
    <h3 className="font-bold text-lg text-[32px] leading-[100%] tracking-[0%]  text-center">Date</h3>
    ...
    <div className="flex justify-between gap-[10px]">
      ...
      <div className="flex justify-between">
        <button className="dateButton flex items-center gap-2"><PiCalendarDotsThin size={25} />Start date</button>
        <button className="dateButton flex gap-2 items-center  leading-[100%] tracking-[0%]"><PiCalendarDotsThin size={25} />End date</button>
      </div>
