...
const SearchBox = ({ open, onClose }) => {
  ...
  return (
    <div
      ref={boxRef}
      className="absolute left-1/2 transform -translate-x-1/2 top-[100px] lg:w-[860px] w-[300px] h-[84px] rounded-[8px] bg-white border border-[#848484] flex items-center gap-2 animate-slideDown z-50 mt-[80px] px-[30px] py-[]22px"
    >
